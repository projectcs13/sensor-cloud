...
sinus_random_data(Amount,StreamId,Delay) ->
        WebMachineUrl = api_help:get_webmachine_url(),
	{A1,A2,A3} = now(),
	...
	JSON = "{\"stream_id\":\""++ lib_json:to_string(StreamId)++"\",\"timestamp\":\"" ++ TimeStamp ++ "\",\"value\":"++ UsedValue ++"}",
	{ok, {{_Version, _Code, _ReasonPhrase}, _Headers, _Body}} = httpc:request(post, {"http://localhost:8000/streams/" ++ lib_json:to_string(StreamId) ++ "/data", [],"application/json", JSON}, [], []),
	timer:sleep(Delay),
...
<<<<<<< HEAD
	{ok, {{_Version1, 200, _ReasonPhrase1}, _Headers1, Body1}} = httpc:request(post, {"http://localhost:8000/users", [],"application/json", "{\"username\":\"Tomas\",\"private\":\"false\"}"}, [], []),
	{ok, {{_Version2, 200, _ReasonPhrase2}, _Headers2, Body2}} = httpc:request(post, {"http://localhost:8000/users", [],"application/json", "{\"username\":\"Alberto\",\"private\":\"false\"}"}, [], []),
	{ok, {{_Version3, 200, _ReasonPhrase3}, _Headers3, Body3}} = httpc:request(post, {"http://localhost:8000/users", [],"application/json", "{\"username\":\"Quentin\",\"private\":\"false\"}"}, [], []),
	{ok, {{_Version4, 200, _ReasonPhrase4}, _Headers4, Body4}} = httpc:request(post, {"http://localhost:8000/users", [],"application/json", "{\"username\":\"Andreas\",\"private\":\"false\"}"}, [], []),
	{ok, {{_Version5, 200, _ReasonPhrase5}, _Headers5, Body5}} = httpc:request(post, {"http://localhost:8000/users", [],"application/json", "{\"username\":\"Jacob\",\"private\":\"false\"}"}, [], []),
=======
	{ok, {{_Version1, 200, _ReasonPhrase1}, _Headers1, Body1}} = httpc:request(post, {WebMachineUrl++"/users", [],"application/json", "{\"username\":\"Tomas\"}"}, [], []),
	{ok, {{_Version2, 200, _ReasonPhrase2}, _Headers2, Body2}} = httpc:request(post, {WebMachineUrl++"/users", [],"application/json", "{\"username\":\"Alberto\"}"}, [], []),
	{ok, {{_Version3, 200, _ReasonPhrase3}, _Headers3, Body3}} = httpc:request(post, {WebMachineUrl++"/users", [],"application/json", "{\"username\":\"Quentin\"}"}, [], []),
	{ok, {{_Version4, 200, _ReasonPhrase4}, _Headers4, Body4}} = httpc:request(post, {WebMachineUrl++"/users", [],"application/json", "{\"username\":\"Andreas\"}"}, [], []),
	{ok, {{_Version5, 200, _ReasonPhrase5}, _Headers5, Body5}} = httpc:request(post, {WebMachineUrl++"/users", [],"application/json", "{\"username\":\"Jacob\"}"}, [], []),
>>>>>>> cd560f98150b71aae7d091d9d3069b97b89ec150
...
<<<<<<< HEAD
	{ok, {{_Version6, 200, _ReasonPhrase6}, _Headers6, Body6}} = httpc:request(post, {"http://localhost:8000/resources", [],"application/json", "{\"user_id\":\""++ lib_json:to_string(User1) ++"\",\"name\":\"Resource1\",\"tags\":\"[temperature,Uppsala]\",\"description\":\"Temperature in Uppsala\",\"type\":\"Temperature\",\"manufacturer\":\"Ericsson\",\"model\":\"MES013\",\"make\":\"\",\"serial\":\"0943123\",\"location\":\"59.8581,17.6447\",\"active\":\"true\",\"uri\":\"http://uppsala.com\",\"polling_freq\":\"20\"}"}, [], []),
	{ok, {{_Version7, 200, _ReasonPhrase7}, _Headers7, Body7}} = httpc:request(post, {"http://localhost:8000/resources", [],"application/json", "{\"user_id\":\""++ lib_json:to_string(User1) ++"\",\"name\":\"Resource2\",\"tags\":\"[temperature,Norrtalje]\",\"description\":\"Temperature in Norrtalje\",\"type\":\"Temperature\",\"manufacturer\":\"Ericsson\",\"model\":\"MES013\",\"make\":\"\",\"serial\":\"0943124\",\"location\":\"59.7667,18.7000\",\"active\":\"true\",\"uri\":\"http://norrtalje.com\",\"polling_freq\":\"20\"}"}, [], []),
	{ok, {{_Version8, 200, _ReasonPhrase8}, _Headers8, Body8}} = httpc:request(post, {"http://localhost:8000/resources", [],"application/json", "{\"user_id\":\""++ lib_json:to_string(User1) ++"\",\"name\":\"Resource3\",\"tags\":\"[temperature,Sala]\",\"description\":\"Temperature in Sala\",\"type\":\"Temperature\",\"manufacturer\":\"Ericsson\",\"model\":\"MES013\",\"make\":\"\",\"serial\":\"0943125\",\"location\":\"59.9167,16.6000\",\"active\":\"true\",\"uri\":\"http://sala.com\",\"polling_freq\":\"20\"}"}, [], []),
=======
	{ok, {{_Version6, 200, _ReasonPhrase6}, _Headers6, Body6}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User1 ++"\",\"name\":\"Resource1\",\"tags\":\"[temperature,Uppsala]\",\"description\":\"Temperature in Uppsala\",\"type\":\"Temperature\",\"manufacturer\":\"Ericsson\",\"model\":\"MES013\",\"make\":\"\",\"serial\":\"0943123\",\"location\":\"59.8581,17.6447\",\"active\":\"true\",\"uri\":\"http://uppsala.com\",\"polling_freq\":\"20\",\"creation_date\":\"2013-09-23\"}"}, [], []),
	{ok, {{_Version7, 200, _ReasonPhrase7}, _Headers7, Body7}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User1 ++"\",\"name\":\"Resource2\",\"tags\":\"[temperature,Norrtalje]\",\"description\":\"Temperature in Norrtalje\",\"type\":\"Temperature\",\"manufacturer\":\"Ericsson\",\"model\":\"MES013\",\"make\":\"\",\"serial\":\"0943124\",\"location\":\"59.7667,18.7000\",\"active\":\"true\",\"uri\":\"http://norrtalje.com\",\"polling_freq\":\"20\",\"creation_date\":\"2013-09-23\"}"}, [], []),
	{ok, {{_Version8, 200, _ReasonPhrase8}, _Headers8, Body8}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User1 ++"\",\"name\":\"Resource3\",\"tags\":\"[temperature,Sala]\",\"description\":\"Temperature in Sala\",\"type\":\"Temperature\",\"manufacturer\":\"Ericsson\",\"model\":\"MES013\",\"make\":\"\",\"serial\":\"0943125\",\"location\":\"59.9167,16.6000\",\"active\":\"true\",\"uri\":\"http://sala.com\",\"polling_freq\":\"20\",\"creation_date\":\"2013-09-23\"}"}, [], []),
>>>>>>> cd560f98150b71aae7d091d9d3069b97b89ec150
...
<<<<<<< HEAD
	{ok, {{_Version15, 200, _ReasonPhrase15}, _Headers15, Body15}} = httpc:request(post, {"http://localhost:8000/resources", [],"application/json", "{\"user_id\":\""++ lib_json:to_string(User2) ++"\",\"name\":\"Resource1\",\"tags\":\"[water-level,Uppsala]\",\"description\":\"Water-level in Uppsala\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLS044\",\"make\":\"\",\"serial\":\"09442353\",\"location\":\"59.8581,17.6447\",\"active\":\"true\",\"uri\":\"http://uppsala.com\",\"polling_freq\":\"20\"}"}, [], []),
	{ok, {{_Version16, 200, _ReasonPhrase16}, _Headers16, Body16}} = httpc:request(post, {"http://localhost:8000/resources", [],"application/json", "{\"user_id\":\""++ lib_json:to_string(User2) ++"\",\"name\":\"Resource2\",\"tags\":\"[water-level,Norrtalje]\",\"description\":\"Water-level in Norrtalje\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLS044\",\"make\":\"\",\"serial\":\"09442353\",\"location\":\"59.7667,18.7000\",\"active\":\"true\",\"uri\":\"http://norrtalje.com\",\"polling_freq\":\"20\"}"}, [], []),
=======
	{ok, {{_Version15, 200, _ReasonPhrase15}, _Headers15, Body15}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User2 ++"\",\"name\":\"Resource1\",\"tags\":\"[water-level,Uppsala]\",\"description\":\"Water-level in Uppsala\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLS044\",\"make\":\"\",\"serial\":\"09442353\",\"location\":\"59.8581,17.6447\",\"active\":\"true\",\"uri\":\"http://uppsala.com\",\"polling_freq\":\"20\",\"creation_date\":\"2013-09-25\"}"}, [], []),
	{ok, {{_Version16, 200, _ReasonPhrase16}, _Headers16, Body16}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User2 ++"\",\"name\":\"Resource2\",\"tags\":\"[water-level,Norrtalje]\",\"description\":\"Water-level in Norrtalje\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLS044\",\"make\":\"\",\"serial\":\"09442353\",\"location\":\"59.7667,18.7000\",\"active\":\"true\",\"uri\":\"http://norrtalje.com\",\"polling_freq\":\"20\",\"creation_date\":\"2013-09-25\"}"}, [], []),
>>>>>>> cd560f98150b71aae7d091d9d3069b97b89ec150
...
<<<<<<< HEAD
	{ok, {{_Version21, 200, _ReasonPhrase21}, _Headers21, Body21}} = httpc:request(post, {"http://localhost:8000/resources", [],"application/json", "{\"user_id\":\""++ User3 ++"\",\"name\":\"Resource1\",\"tags\":\"[water-level,Uppsala]\",\"description\":\"Water-level in Uppsala\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLS044\",\"make\":\"\",\"serial\":\"09442358\",\"location\":\"59.8581,17.6447\",\"active\":\"true\",\"uri\":\"http://uppsala.com\",\"polling_freq\":\"40\"}"}, [], []),
...
=======
	{ok, {{_Version21, 200, _ReasonPhrase21}, _Headers21, Body21}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User3 ++"\",\"name\":\"Resource1\",\"tags\":\"[water-level,Uppsala]\",\"description\":\"Water-level in Uppsala\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLS044\",\"make\":\"\",\"serial\":\"09442358\",\"location\":\"59.8581,17.6447\",\"active\":\"true\",\"uri\":\"http://uppsala.com\",\"polling_freq\":\"40\",\"creation_date\":\"2013-09-29\"}"}, [], []),
	U3Resource1 = lib_json:get_field(Body21,"_id"),
	
	%% Create stream for resource1 for user3
	{ok, {{_Version22, 200, _ReasonPhrase22}, _Headers22, Body22}} = httpc:request(post, {WebMachineUrl++"/streams", [],"application/json", "{\"resource_id\":\""++ U3Resource1 ++"\",\"name\":\"Stream1\",\"tags\":\"[water-level,Uppsala]\",\"description\":\"Water-level in Fyrisan in Uppsala\",\"private\":\"true\",\"type\":\"Water-level\",\"unit\":\"meter\",\"accuracy\":0.95,\"min_val\":0.0,\"max_val\":15.0,\"active\":\"true\",\"user_ranking\":10.0,\"subscribers\":169,\"last_updated\":\"2013-10-05T010502.0000\", \"creation_date\":\"2013-10-01\",\"history_size\": 5000,\"location\":\"59.8581,17.6447\"}"}, [], []),
>>>>>>> cd560f98150b71aae7d091d9d3069b97b89ec150
...
<<<<<<< HEAD
	{ok, {{_Version23, 200, _ReasonPhrase23}, _Headers23, Body23}} = httpc:request(post, {"http://localhost:8000/resources", [],"application/json", "{\"user_id\":\""++ User4 ++"\",\"name\":\"Resource1\",\"tags\":\"[water-level,Uppsala]\",\"description\":\"Water-level in Uppsala\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLA099\",\"make\":\"\",\"serial\":\"AACV223\",\"location\":\"59.8581,17.6447\",\"active\":\"true\",\"uri\":\"http://uppsala.com\",\"polling_freq\":\"60\"}"}, [], []),
	...
	{ok, {{_Version25, 200, _ReasonPhrase25}, _Headers25, Body25}} = httpc:request(post, {"http://localhost:8000/resources", [],"application/json", "{\"user_id\":\""++ User4 ++"\",\"name\":\"Resource3\",\"tags\":\"[water-level,Sala]\",\"description\":\"Water-level in Sala\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLA099\",\"make\":\"\",\"serial\":\"AACV225\",\"location\":\"59.9167,16.6000\",\"active\":\"true\",\"uri\":\"http://sala.com\",\"polling_freq\":\"60\"}"}, [], []),
	{ok, {{_Version26, 200, _ReasonPhrase26}, _Headers26, Body26}} = httpc:request(post, {"http://localhost:8000/resources", [],"application/json", "{\"user_id\":\""++ User4 ++"\",\"name\":\"Resource4\",\"tags\":\"[water-level,Stockholm]\",\"description\":\"Water-level in Stockholm\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLA099\",\"make\":\"\",\"serial\":\"AACV227\",\"location\":\"59.3294,18.0686\",\"active\":\"true\",\"uri\":\"http://stockholm.com\",\"polling_freq\":\"60\"}"}, [], []),
=======
	{ok, {{_Version23, 200, _ReasonPhrase23}, _Headers23, Body23}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User4 ++"\",\"name\":\"Resource1\",\"tags\":\"[water-level,Uppsala]\",\"description\":\"Water-level in Uppsala\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLA099\",\"make\":\"\",\"serial\":\"AACV223\",\"location\":\"59.8581,17.6447\",\"active\":\"true\",\"uri\":\"http://uppsala.com\",\"polling_freq\":\"60\",\"creation_date\":\"2013-10-05\"}"}, [], []),
	{ok, {{_Version24, 200, _ReasonPhrase24}, _Headers24, Body24}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User4 ++"\",\"name\":\"Resource2\",\"tags\":\"[water-level,Norrtalje]\",\"description\":\"Water-level in Norrtalje\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLA099\",\"make\":\"\",\"serial\":\"AACV224\",\"location\":\"59.7667,18.7000\",\"active\":\"true\",\"uri\":\"http://norrtalje.com\",\"polling_freq\":\"60\",\"creation_date\":\"2013-10-05\"}"}, [], []),
	{ok, {{_Version25, 200, _ReasonPhrase25}, _Headers25, Body25}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User4 ++"\",\"name\":\"Resource3\",\"tags\":\"[water-level,Sala]\",\"description\":\"Water-level in Sala\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLA099\",\"make\":\"\",\"serial\":\"AACV225\",\"location\":\"59.9167,16.6000\",\"active\":\"true\",\"uri\":\"http://sala.com\",\"polling_freq\":\"60\",\"creation_date\":\"2013-10-05\"}"}, [], []),
	{ok, {{_Version26, 200, _ReasonPhrase26}, _Headers26, Body26}} = httpc:request(post, {WebMachineUrl++"/resources", [],"application/json", "{\"user_id\":\""++ User4 ++"\",\"name\":\"Resource4\",\"tags\":\"[water-level,Stockholm]\",\"description\":\"Water-level in Stockholm\",\"type\":\"Water-level\",\"manufacturer\":\"Ericsson\",\"model\":\"WLA099\",\"make\":\"\",\"serial\":\"AACV227\",\"location\":\"59.3294,18.0686\",\"active\":\"true\",\"uri\":\"http://stockholm.com\",\"polling_freq\":\"60\",\"creation_date\":\"2013-10-05\"}"}, [], []),
>>>>>>> cd560f98150b71aae7d091d9d3069b97b89ec150

...
sinus_random_data(Amount,StreamId,Delay) ->
	...
	JSON = "{\"stream_id\":\""++ StreamId++"\",\"timestamp\":\"" ++ TimeStamp ++ ".0000\",\"value\":"++ UsedValue ++"}",
...
add_data() ->
	...
	User1 = lib_json:to_string(lib_json:get_field(Body1,"_id")),
	User2 = lib_json:to_string(lib_json:get_field(Body2,"_id")),
	User3 = lib_json:to_string(lib_json:get_field(Body3,"_id")),
	User4 = lib_json:to_string(lib_json:get_field(Body4,"_id")),
	...
	U2R1Stream1 = lib_json:to_string(lib_json:get_field(Body17,"_id")),
	U2R1Stream2 = lib_json:to_string(lib_json:get_field(Body18,"_id")),
	U2R1Stream3 = lib_json:to_string(lib_json:get_field(Body19,"_id")),
	...
	U2R2Stream1 = lib_json:to_string(lib_json:get_field(Body20,"_id")),
	...
	U3Resource1 = lib_json:to_string(lib_json:get_field(Body21,"_id")),
	...
	U3R1Stream1 = lib_json:to_string(lib_json:get_field(Body22,"_id")),

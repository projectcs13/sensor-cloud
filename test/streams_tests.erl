...
get_stream_test() ->
	% Test create
	{ok, {{_Version1, 200, _ReasonPhrase1}, _Headers1, Body1}} = httpc:request(post, {"http://localhost:8000/streams", [],"application/json", "{\"test\" : \"get\",\"user_id\" : 0, \"resource_id\" : \"asdascvsr213sda\", \"private\" : \"0\"}"}, [], []),
	{ok, {{_Version2, 200, _ReasonPhrase2}, _Headers2, Body2}} = httpc:request(post, {"http://localhost:8000/streams", [],"application/json", "{\"test\" : \"get\",\"user_id\" : 0, \"resource_id\" : \"asdascvsr213sda\", \"private\" : \"0\"}"}, [], []),
	DocId1 = get_id_value(Body1,"_id"),
	DocId2 = get_id_value(Body2,"_id"),
	refresh(),
	% Test get and search
	...
	?assertEqual(true,get_value_field(Body3,"private") == "0"),
	...
	?assertEqual("get",get_value_field(Body6,"test")),

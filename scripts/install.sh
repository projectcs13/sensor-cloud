...
echo "#################################################################"
wget http://packages.erlang-solutions.com/site/esl/esl-erlang/FLAVOUR_1_general/esl-erlang_17.1-1~ubuntu~precise_amd64.deb
sudo dpkg -i esl-erlang_17.1.1~ubuntu~precise_amd64.deb
rm esl-erlang_17.1.1~ubuntu~precise_amd64.deb
